...
<head>
    ...
    <title>Register - Band Manager</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        ul.errors { margin: 8px 0 0; padding-left: 20px; list-style: none; }
        ul.errors li { color: #ffdada; padding: 4px 0; }
        ul.errors li:before { content: "• "; color: #ff4757; font-weight: bold; }
...
<body>
    ...
    <div class="container">
        ...
        <p class="sub">Join to manage your band roster</p>
        ...
        <form action="<?= site_url('register') ?>" method="POST">
            ...
            <input type="text" id="username" name="username" placeholder="Choose a username" value="<?= isset($old['username']) ? htmlspecialchars($old['username']) : '' ?>" required autofocus />

            <label for="email">Email Address</label>
            <input type="email" id="email" name="email" placeholder="you@example.com" value="<?= isset($old['email']) ? htmlspecialchars($old['email']) : '' ?>" required />
            ...
            <div class="actions">
                ...
                <a class="link" href="<?= site_url('login') ?>">← Back to login</a>
            </div>
        </form>
    </div>
</body>
